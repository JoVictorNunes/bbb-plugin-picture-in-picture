...
export function LayoutProvider({
  ...
  const [layout, setLayout] = React.useState<LayoutContext | null>(null);

  React.useEffect(() => {
    setLayout((prev) => ({
      ...prev,
      swapped: (presenter || moderator) && hasScreenshare && hasCameras,
    }));
  ...
  }, [pipWindow, hasScreenshare, hasCameras, layout?.swapped]);
